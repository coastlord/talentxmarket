...
export default function SignUp() {
  return (
    <section id="get-started" className="py-24 bg-brand-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-10 flex flex-col">
            <span className="inline-flex items-center gap-2 bg-brand-gold/10 text-brand-gold text-sm font-semibold px-4 py-2 rounded-full border border-brand-gold/30 mb-8 self-start">
          ...
          <div className="relative">
            ...
            <div className="relative bg-brand-black border border-brand-gold/20 rounded-3xl p-10 overflow-hidden h-full flex flex-col">
