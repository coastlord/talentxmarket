...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-brand-black/95 backdrop-blur-md shadow-lg' : 'bg-transparent'}`}>
          ...
          <div className="md:hidden bg-brand-black border-t border-white/10 py-4">
            <div className="flex flex-col gap-4 px-4">
              ...
              <Link href="/talent" className="flex items-center gap-1.5 text-brand-gold text-sm font-semibold" onClick={() => setMenuOpen(false)}>
                <span className="w-1.5 h-1.5 rounded-full bg-green-400 animate-pulse" />Browse Talent
              </Link>
              <Link href="/jobs" className="flex items-center gap-1.5 text-brand-gold text-sm font-semibold" onClick={() => setMenuOpen(false)}>
                <span className="w-1.5 h-1.5 rounded-full bg-amber-400 animate-pulse" />Browse Jobs
              </Link>
              <Link href="/intelligence" className="flex items-center gap-1.5 text-brand-gold text-sm font-semibold" onClick={() => setMenuOpen(false)}>
                <span className="w-1.5 h-1.5 rounded-full bg-blue-400 animate-pulse" />Intelligence Hub
              </Link>
