          ...
          <div className="flex-1 flex items-center justify-center px-8 sm:px-12 xl:px-16 py-12">
            <div className="w-full max-w-[400px]">
              ...
              <button
                ...
                className="tx-btn-google w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl text-sm font-medium text-[#0A0A0A] bg-white disabled:opacity-70 disabled:cursor-not-allowed"
                style={{ fontFamily: 'Inter, sans-serif', border: '1px solid #E5E7EB' }}
              >
                {googleLoading ? (
                  <>
                    <svg className="animate-spin w-[18px] h-[18px] flex-shrink-0 text-gray-400" fill="none" viewBox="0 0 24 24">
