...
function ProfessionalCard({ pro }: { pro: Professional }) {
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-2xl p-5 hover:shadow-xl hover:border-brand-gold/25 transition-all duration-300 flex flex-col group">
      ...
      {/* ── UNLOCK BUTTON ── */}
      <button className="mt-auto w-full flex items-center justify-center gap-2 bg-brand-black hover:bg-brand-gold text-white hover:text-brand-black text-sm font-bold py-3 rounded-xl transition-all duration-200 group-hover:bg-brand-gold group-hover:text-brand-black">
